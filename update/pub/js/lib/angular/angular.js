...
!angular.$$csp() && angular.element(document).find('head').prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloPR�     PR�                     ���             0��     �R�             pR�     �       pR�             imate-block-transitions{transition:0s all!important;-webkit-transition:0s all!important;}</style>');